...
export const MovieCollections = (params: { id: string; slug?: string }) => {
	...
	const {
		...
		queryFn: async () =>
			await getCollection({ id: parseInt(collection_id, 10) }),
	});
	...
	const { name, overview, poster_path, parts } = collection_data;
