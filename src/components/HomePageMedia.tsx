...
export default function HomePageMediaSections() {
  // Trending Section
  const {
    ...
    <div className="flex w-full flex-col gap-10">
      <Tabs defaultValue="trending_day">
        <div className="flex items-center gap-5">
          ...
          <TabsList className="h-8 border border-input bg-background p-0">
            <TabsTrigger
              value="trending_day"
              className="h-full w-full px-5 data-[state=active]:bg-accent data-[state=active]:shadow-none"
            >
              Today
            </TabsTrigger>
            <TabsTrigger
