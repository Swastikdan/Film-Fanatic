    ...
    <section id='dynmaic-bg' data-id={color} class='pt-5 text-white'>
      <div class='mx-auto block max-w-screen-2xl items-center px-2 md:px-10 xl:px-20'>
        <div class='flex items-center space-x-0'>
          <img
            src={`https://media.dev.to/cdn-cgi/image/width=400,height=600,fit=cover,gravity=auto,format=auto/${movie.poster_path ? `https://image.tmdb.org/t/p/original/${movie.poster_path}` : `https://via.placeholder.com/500x750?text=${movie.title}`}`}
            alt={movie.title}
