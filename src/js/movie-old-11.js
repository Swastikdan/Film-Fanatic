...
moviepreviewContainer.innerHTML = "<p>Loading...</p>";
movieDetailsContainer.innerHTML = "<p>Loading...</p>";
...
<li class=" rounded-xl">
    <div
    class="absolute inset-0 flex items-center justify-center bg-gray-300 dark:bg-gray-8000 -z-10 rounded-xl animate-pulse ">
  </div>
